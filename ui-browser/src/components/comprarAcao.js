...
class App extends Component {
    ...
    confirm() {
        ...
        this
            .props
            .venderAcao({valor, codigo, qtd: quantidadeCompras})
    ...
    render() {
        ...
        return <Container>
                ...
                <Col>
                    <Form onSubmit={this.venda}>
                        <Form.Group controlId="formBasicEmail">
                            ...
                            <Form.Label>VALOR:
                                <b>
                                    {valor || <b style={{color:'red'}}> selecione um lance !</b>}
                                </b>
                            </Form.Label>
                            <Form.Control
                                onChange={({target}) => {
            ...
            <Row className="board-cards">
                {lances.map((lance, ids) => <Card
                    key={`of${ids}`}
                    onDoubleClick={() => this.fSetLance(lance)}
                    ...
                    <Card.Body>
                        <Card.Title><label>VALOR R$ {lance.valor}</label></Card.Title>
                        <Card.Text>
                            <label>QUANTIDADE : {lance.qtd} </label>
                        </Card.Text>
                    </Card.Body>
                </Card>)}
            </Row>
